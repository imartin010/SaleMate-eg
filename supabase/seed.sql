...
INSERT INTO partners (id, name, description, commission_rate, logo_path, website, status) VALUES
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'The Address Investments', 'Leading real estate investment firm specializing in premium properties across Egypt.', 15.00, 'partners-logos/address-investments.png', 'https://address-investments.com', 'active'),
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Bold Routes', 'Innovative real estate solutions with focus on emerging markets and high-growth areas.', 12.50, 'partners-logos/bold-routes.png', 'https://boldroutes.com', 'active'),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Nawy', 'Digital real estate platform connecting buyers with verified properties and trusted agents.', 18.00, 'partners-logos/nawy.png', 'https://nawy.com', 'active'),
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Coldwell Banker', 'Global real estate brand with local expertise in Egyptian market.', 20.00, 'partners-logos/coldwell-banker.png', 'https://coldwellbanker.com', 'active');
