/**
 * @deprecated
 * This file is deprecated. The Supabase client is now imported from '@/core/api/client'.
 * Helper functions in this file will be migrated to proper service layers.
...
if (import.meta.env.DEV) {
  console.warn(
    '⚠️ DEPRECATED: Importing from src/lib/supabaseClient.ts is deprecated.\n' +
...
// Get environment variables (needed for some helper functions below)
