...
const PartnersPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50/30 via-blue-50/20 to-white">
      ...
      {/* Project Cards - Matching Shop Page Design */}
                ...
                <div className="relative h-52 w-full overflow-hidden">
                  ...
                  <div className="absolute top-2 right-2">
                    <button 
                      ...
                      className="bg-white/90 backdrop-blur-sm text-gray-700 px-1.5 py-0.5 rounded text-[10px] font-medium shadow-sm border border-gray-200/50 hover:bg-white transition-all"
                ...
                <CardContent className="px-3 pt-2 pb-1.5 space-y-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="text-left p-2 bg-blue-50/50 rounded-lg">
                      <div className="text-xs text-gray-500 mb-0.5 font-medium">Starting Price</div>
