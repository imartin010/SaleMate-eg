...
import { BackgroundDecor } from '../../marketing/components/Decor';

const PerformanceFinalCTA = () => {
  const features = [
      ...
      <div className="container relative mx-auto px-4 sm:px-6 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              Join our comprehensive performance platform and transform your franchise operations through real-time tracking, financial analytics, and AI-powered insights. 
              Secure, compliant, and designed for growth.
            </motion.p>
...
export default PerformanceFinalCTA;
