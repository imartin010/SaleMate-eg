    ...
    try {
      ...
      if (paymentMethod === 'card') {
        ...
        if (paymentResult.success && paymentResult.transactionId) {
          // If redirect URL provided (Kashier), redirect in same window
          if (paymentResult.redirectUrl && gateway === 'kashier') {
            // Close the modal first
            onClose();
            
            // Redirect to Kashier payment page in the same window
            // The callback page will handle the redirect back and update the wallet
