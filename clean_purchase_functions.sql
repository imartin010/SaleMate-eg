-- CLEAN PURCHASE FUNCTIONS - NO SYNTAX ERRORS
-- Run this in Supabase SQL Editor

-- 1) Create rpc_get_project_availability function
...
-- 2) Create rpc_start_order function
...
-- 3) Create rpc_confirm_order function
